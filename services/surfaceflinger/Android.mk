...
# On rk3326/rk3126c,it cann't support 4K,so we don't need RK_LOW_MEM_SUPPORT.
ifneq ($(filter rk3326 rk3126c, $(strip $(TARGET_BOARD_PLATFORM))), )
RK_LOW_MEM_SUPPORT := 0
else
RK_LOW_MEM_SUPPORT := 1
endif
...
LOCAL_CFLAGS += -DRK_USE_DRM=$(RK_USE_DRM) -DRK_USE_3_FB=$(RK_USE_3_FB) -DRK_USE_3_LAYER_BUFFER=1 \
		...
		-DRK_LOW_MEM_SUPPORT=$(RK_LOW_MEM_SUPPORT)
